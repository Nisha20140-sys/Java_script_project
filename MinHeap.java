...
class MinHeap {
    ...
    public static boolean leafy(int i) {
    ...
    public static void minfy(int i) {
        if (!leafy(i)) {
    ...
    public static void main(String[] args) {
        ...
        r.insert(6);
        r.minHeapt();
        System.out.println("The Min Heap is : " + Arrays.toString(r.arr));
    }
}
